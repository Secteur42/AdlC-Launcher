...
function showFatalStartupError(){
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent('Erreur fatale : Impossible de charger l\'index de distribution',
                'Une connexion n\'a pu être établie avec nos serveurs pour télécharger l\'index de distribution. Aucune copie locale n\'était disponible pour le chargement. <br><br>L\'index de distribution est un fichier essentiel qui fournit les dernières informations sur les serveurs. Le lanceur est incapable de démarrer sans lui. Assurez-vous que vous êtes connecté à Internet et relancez l\'application.',
                'Fermer'
            )
            setOverlayHandler(() => {
    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                ...
                `Nous n'avons pas pu rafraîchir la connexion pour <strong>${selectedAcc.displayName}</strong>. Please ${accLen > 0 ? 'select another account or ' : ''} login again.`,
                'Connexion',
